...
<html lang="en">
<head>
  <script src="js/jquery.min.js"></script> <script src="js/jquery.snow.js"></script>
  <head>
  ...
  $(document).ready(function() {
    ...
    jQuery(document).snowfall({
      ...
      maxFlakes : 100, // Số lượng bông tuyết tối đa
      minSize : 5, // Kích thước bông tuyết nhỏ nhất
      maxSize : 10 // Kích thước bông tuyết lớn nhất
    });
  });
</script>
...
<body>
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4549971620139373"
     crossorigin="anonymous"></script>
<!-- Animepostcard -->
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-4549971620139373"
     data-ad-slot="3591189518"
     data-ad-format="auto"
...
<style>
	html,body{cursor:url("assets/img/katana.png"), auto;}
	a:hover{cursor:url("assets/img/katana.png"), auto;}
</style>

<script>
    const confetti = new JSConfetti();
    confetti.addConfetti({
      emojis: ['❄️'], // Sử dụng emoji bông tuyết
      // Các tùy chỉnh khác như màu sắc, số lượng, tốc độ
    });
  </script>
</body>
    ...
    <style>
    	header.masthead {
		  background: url(assets/img/food-bg.jpg);
