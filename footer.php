...
$initial_value = 0; // Giá trị ban đầu
...
echo "<p>Số lượng người truy cập: $counter</p>";
?>

<script async src="https://www.thegioididong.com/"
...
<body>
    <div class="box">
        <h1>Quảng Cáo</h1>
        <p>Khuyến mãi đặc biệt chỉ trong hôm nay!</p>
    </div>
</body>
</html>